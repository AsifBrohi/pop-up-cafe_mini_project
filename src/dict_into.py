...
def courier_file():
    with open('/Users/AsifB/Documents/Data_engineering_new_gen/pop_up_cafe_project/data/courier.csv', 'w+', newline='') as output_file:
...
def orders_menu_file():
    ...
    with open('/Users/AsifB/Documents/Data_engineering_new_gen/pop_up_cafe_project/data/orders.csv', 'w+', newline='') as output_file:
